...
Route::middleware('auth:employer')->group(function () {
    Route::group(['prefix' => "employer"], function () {
        ...
        Route::put('password', [EmployerController::class, 'update_password'])->name('password.update');

        Route::post('/logout', [EmployerController::class, 'destroy'])
            ->name('logout');
    });
});
